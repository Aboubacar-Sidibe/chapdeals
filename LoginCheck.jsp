<%-- 
    Document   : LoginCheck
    Created on : Feb 28, 2019, 3:04:56 PM
    Author     : sprinklr
--%>
...
<html>
    ...
    <body>
        ...
        <div id="modal" style="position: absolute;width: 100%;"> 


            <form id="regForm" action="./LoginController" method="post">
                ...
                <h1><fmt:message key="Title"/>:</h1> <span class="w3-right"><a href="AdminLogin.jsp" class="w3-text-pink"><fmt:message key="SignUpMessage"/></a></span>
                <!-- One "tab" for each step in the form: -->
                <div>
                    <label><fmt:message key="message"/> </label>
                    <p><input  placeholder="<fmt:message key="message"/>"  type="number" name="phone" required=""></p>

                </div>

                <div>
                    <label><fmt:message key="passwordChoice"/> </label><br>
                    <header>

                    </header>
                    <a class="w3-bar-item w3-button w3-pink" onclick="openCity('Paris')"><fmt:message key="Pattern"/> <i class="fa fa-braille"></i></a>
                    <span class="w3-text-white">or</span> <a class="w3-bar-item w3-button w3-pink" onclick="openCity('London')"><fmt:message key="Conventional"/> <i class="fa fa-lock"></i></a>
                    ...
                    <div id="London" class="w3-container city" style="display: none">
                        ...
                        <div class="row pass w3-input w3-border-pink">
