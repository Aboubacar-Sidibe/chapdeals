    ...
    <body>
        <section class="chat-container w3-card-4"> 
            <div class="w3-top">
                <div class="w3-theme w3-col s12 m7 l5">
                    ...
                    <div class="msg-header-img">
                        <img  src="../images/1.jpg" class="w3-circle" height="40" width="40"/>
                    </div>

                    <div class="active">
                        <h4>${sessionScope.customer.username}</h4>
            ...
            <div class="msg-bottom  w3-col s12 m7 l5">
                ...
                <i  class="fa fa-microphone w3-right" id=record></i>
            </div>
        ...
        <script>
                        ...
                        const key = '${sessionScope.customer.key}';
                        ...
                        function  sendOutgoingChat()
                        {
                            ...
                            const name = '${sessionScope.customer.username}';

                            document.getElementById("content").value = "";

                            messageRef = firebase.database().ref('rooms/' + key).push();
                            messageRef.update({
                                content: text,
                                created: dateString,
                                senderId: key,
                        ...
                        messageRef = firebase.database().ref('rooms/' + key);
